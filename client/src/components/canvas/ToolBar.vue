...
<template>
  ...
  >
    <!-- Left scroll arrow (mobile only, visible when scrolled right) -->
    <button
    ...
    <!-- Scrollable tool row (overflow hidden on mobile, display:contents on desktop) -->
    <div
    ...
    <!-- Right scroll arrow (mobile only, visible when more content to the right) -->
    <button
...
<style scoped>
/* ── Mobile: clip and hide native scrollbar ── */
...
/* ── Desktop: flatten the wrapper into parent flex ── */
